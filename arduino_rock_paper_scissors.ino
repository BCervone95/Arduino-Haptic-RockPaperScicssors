...
// Authors:   Benedetta Cervone & Nicky ter Maat
// Date:      10-2020
//
// Source code for an interactive haptic Rock Paper Scissors glove.
// Utilizes a flex sensor, capacitive sensors to estimate the sign of the player. LED lights and vibration motors are used to provide haptic and visual feedback about the game result.
// Serial communication with a Processing sketch allows for game control and for players to play over the internet.
...
void collectData() {
  ...
  flexMean = flexTotal / 10;
  touchMean = touchTotal / 10;
}
